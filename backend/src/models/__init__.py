...
def select_model(config):
    ...
    if model_provider == "deepseek":
        from src.models.chat_model import DeepSeekNew
        return DeepSeekNew(model_name)

    elif model_provider == "deepseekNew":
        from src.models.chat_model import DeepSeekLocal
        return DeepSeekLocal(model_name)

    elif model_provider == "zhipu":
        from src.models.chat_model import ZhipuNew
        ...
        from src.models.chat_model import OpenModelNew
        return OpenModelNew(model_name)

    elif model_provider == "siliconflow":
        from src.models.chat_model import SiliconFlowNew
